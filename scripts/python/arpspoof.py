...
def setup(args):
    ...
    if args.no_routing:
        print("### Ignore changes, Kernel Routing Disabled")
    else:
...
def arp_poison(ip_a, mac_a, ip_b, mac_b, local_mac):
    ...
    try:
        ...
        print(f"{log_timestamp()} ARP poisoning stopped by user.")
...
def main():
    ...
    if mac_target and mac_spoof:
        try:
            ...
            print(f"{log_timestamp()} Stopping ARP poisoning stopped by user.")
